...
![](https://blog.kakaocdn.net/dna/bjvfhH/btq40RjM1JJ/AAAAAAAAAAAAAAAAAAAAALLheBjtbI6DcHye5wmlvD2HvsbQfc7PvBSTLHWW_v71/img.jpg?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=s%2Bq3cD8DKcD6d90rvDnoVXedORk%3D)
...
\- DB 테이블로 상상해서 생각해보면 JOIN을 고려했을 때 테이블 모델링을 하면 TEAM\_ID라는 FK는 멤버 테이블에 있는 게 일반적으로 생각할 수 있는 모습이다.
