...
im-developer.tistory.com](https://im-developer.tistory.com/166)
...
en.wikipedia.org](https://en.wikipedia.org/wiki/JavaBeans)
...
HIKARI\_CP, JACKSON, MYBATIS 등의 특정 서드파티 라이브러리를 적용할 때 혼란을 최소화하도록 의존성 부분의 설정을 최소화시켰다.
