...
doljae.tistory.com](https://doljae.tistory.com/199)
...
![](https://blog.kakaocdn.net/dna/cBDKNN/btrbhX7DoRZ/AAAAAAAAAAAAAAAAAAAAAJwELuuFWDn3TOofqkVkGtbiT6rfAOqZQhc4q5xLt98u/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=1niKcaNLH2otPFhQwDmH76SDvqE%3D)
...
![](https://blog.kakaocdn.net/dna/EFEje/btrbdZxGTpO/AAAAAAAAAAAAAAAAAAAAAAHldI5CnCbAVUy3jYhk5snf0PZlszMyfEWjelK-MTxc/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=yJsYcU6V8FEgmGopy4LYnzAc9Mw%3D)
...
![](https://blog.kakaocdn.net/dna/bILF5J/btrbagsSqRl/AAAAAAAAAAAAAAAAAAAAABTm8LnMCcqn3UfeV9nqT_1VBaIZyfXvhDpAFkgqzGFk/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=xeXHBvR3tS5Ac7xi3kqXjL92UpY%3D)
...
![](https://blog.kakaocdn.net/dna/bg9tG6/btrbag0OlWs/AAAAAAAAAAAAAAAAAAAAAORkSVJLMxooHx2JfJFwLvu-q4YeafgwbVnNpOip4xNx/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=trK7awx751aRyL4Dt9k7H%2BFOONk%3D)
...
-   3번 방법은 Python에 built-in 함수인 pow를 호출해서 사용한다.
    -   모든 것이 PyObject라는 객체로 되어있는 Python에서 pow를 호출하면 해당 Object에 내장되어 있는 매직 메서드인 \_\_pow\_\_를 호출해서 연산을 하게 된다.
...
![](https://blog.kakaocdn.net/dna/bGsGUU/btrbpQF8KvQ/AAAAAAAAAAAAAAAAAAAAAAK4WZw5VKe02HSI2OtC54J53YWxkSnjYYiXw8X7eJfy/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=aolSop6kZQ8rrJdqAjIfL5WeLR4%3D)
...
stackoverflow.com](https://stackoverflow.com/questions/10282674/difference-between-the-built-in-pow-and-math-pow-for-floats-in-python)
...
stackoverflow.com](https://stackoverflow.com/questions/20969773/exponentials-in-python-xy-vs-math-powx-y)

 [Python의 큰 정수 표현법 1

개요 대부분의 프로그래밍 언어, 특히 거의 모든 저레벨 언어에는 정수형 크기에 제한이 있습니다. 대체로 바이트 단위로 끊어서 1바이트, 2바이트, 4바이트, 8바이트 정도의 정수형들을 사용할

www.secmem.org](https://www.secmem.org/blog/2019/06/16/python-biginteger/)
