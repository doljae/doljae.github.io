...
www.acmicpc.net](https://www.acmicpc.net/problem/3954)

### 문제 개요

![](https://blog.kakaocdn.net/dna/bcZpjN/btqSpGagNk3/AAAAAAAAAAAAAAAAAAAAAGhU_lVjOz5Xk9q3Va-1l59H1DOGFDWEVR4RcfwauXY6/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=dBSlgWVYEcsYg3tv6LN85DLciMw%3D)
...
&lt;table style="border-collapse: collapse; width: 100%; height: 160px;" border="1"&gt;&lt;tbody&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;-&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;포인터가 가리키는 수를 1 감소시킨다. (modulo 2^&lt;/span&gt;8&lt;span&gt;)&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;+&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;포인터가 가리키는 수를 1 증가시킨다. (modulo 2^&lt;/span&gt;8&lt;span&gt;)&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;포인터를 왼쪽으로 한 칸 움직인다.&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;&gt;&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;포인터를 오른쪽으로 한 칸 움직인다.&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;[&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;만약 포인터가 가리키는 수가 0이라면,&nbsp;&lt;/span&gt;[&lt;span&gt;&nbsp;와 짝을 이루는&nbsp;&lt;/span&gt;]&lt;span&gt;&nbsp;의 다음 명령으로 점프한다.&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;]&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;만약 포인터가 가리키는 수가 0이 아니라면,&nbsp;&lt;/span&gt;]&lt;span&gt;&nbsp;와 짝을 이루는&nbsp;&lt;/span&gt;[&lt;span&gt;&nbsp;의 다음 명령으로 점프한다.&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;. (온점)&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;포인터가 가리키는 수를 출력한다.&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr style="height: 20px;"&gt;&lt;td style="width: 50%; height: 20px;"&gt;, (쉼표)&lt;/td&gt;&lt;td style="width: 50%; height: 20px;"&gt;&lt;span&gt;문자 하나를 읽고 포인터가 가리키는 곳에 저장한다. 입력의 마지막(EOF)인 경우에는 255를 저장한다.&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/tbody&gt;&lt;/table&gt;
...
www.acmicpc.net](https://www.acmicpc.net/board/view/50721)
