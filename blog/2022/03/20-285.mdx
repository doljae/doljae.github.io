...
[Spring Boot 2.6 Release note](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.6-Release-Notes)를 보면 다음과 같은 변경 사항이 눈에 들어온다.

<!-- truncate -->

![](https://blog.kakaocdn.net/dna/bKfWuw/btrwon5RYBu/AAAAAAAAAAAAAAAAAAAAAAIHJFg5xJGtKmEAgRKUlcbk4WTRlnoyAxCgmAMKoyes/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=xuFQeNZGhfNs9x%2FKkv8aei6VgSU%3D)

-   기본 PathPattern 매칭 전략이 AntPathMatcher → PathPatternParser로 변경되었다.

![](https://blog.kakaocdn.net/dna/kPKdb/btrwp0vB7uu/AAAAAAAAAAAAAAAAAAAAAPp7KLOK8kzFKZyvNo_f1oVtcytvg4QXbJhBVf4-liyf/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=SuQCHh99plU1qnNMVMKuBj%2FQCFo%3D)

-   Release note에도 springfox를 사용하고 있다면 정상적으로 프로젝트가 실행되지 않을 것이라고 언급하고 있다.

![](https://blog.kakaocdn.net/dna/cb8t0I/btrwnPIiR3a/AAAAAAAAAAAAAAAAAAAAAJ1GyXIp3JLJshrz5HC7uPXr6xYqRvcRuVrAWMXderKf/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=f2psnZPB6f%2B7qsPbgHQJ4ZzHHz4%3D)

Swagger-ui

-   springfox는 Spring Web Component를 기반으로 별다른 설정 없이 지원하는 API를 기반으로 [Swagger-ui](https://swagger.io/tools/swagger-ui/)를 그려주는 의존성이다.
-   관련 이슈 링크
    -   [https://github.com/springfox/springfox/issues/3462](https://github.com/springfox/springfox/issues/3462)

### 원인

springfox 의존성이 swagger-ui를 그릴 때 사용하는 클래스 중 하나인 [**WebMvcRequestHandlerProvider**](https://github.com/springfox/springfox/blob/master/springfox-spring-webmvc/src/main/java/springfox/documentation/spring/web/plugins/WebMvcRequestHandlerProvider.java)에서 원인을 발견할 수 있었다.

![](https://blog.kakaocdn.net/dna/uFN4U/btrwpZKcxz1/AAAAAAAAAAAAAAAAAAAAAJAxQWpbqpymPNQGfw_GCaWtrjtO40buQjZhIUrwy-fH/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=7ndJBhDRxYFObj5jiHkO2azUqXA%3D)
...
![](https://blog.kakaocdn.net/dna/qxvdb/btrwsJzSbox/AAAAAAAAAAAAAAAAAAAAAOBltONyWP42dQU7qYgHLiUrTZGTojvmgk2IqPMise-w/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1772290799&allow_ip=&allow_referer=&signature=Y1XQ%2FsThJW6gpCKkM8ErJIRExFw%3D)
...
이것이 [springdoc-openapi](https://github.com/springdoc/springdoc-openapi)로 이주하게 된 계기가 되었다.
